 ...
 * @format
 */
import type {MenuItem} from '@fbcsymphony/design-system/components/Menu/SideMenu';
import type {ViewContainerProps} from '@fbcsymphony/design-system/components/View/ViewContainer';

import * as React from 'react';
import SideMenu from '@fbcsymphony/design-system/components/Menu/SideMenu';
import ViewContainer from '@fbcsymphony/design-system/components/View/ViewContainer';
import {
  Redirect,
  Route,
  Switch,
